...
## 更新摘要
**变更内容**
- 新增媒体信息通道（MediaInfo Channel）支持，提供独立的媒体状态传输通道
- 添加媒体统计功能，包括帧率、码率、网络延迟和丢帧统计
- 实现媒体控制命令的分离传输，避免大数据帧阻塞控制信息
- 增强媒体质量监控和实时状态反馈能力
...
- [p2p_service.rs:1-1000](file://src-tauri/src/service/p2p_service.rs#L1-L1000)
- [p2p_controller.rs:1-227](file://src-tauri/src/cmd/p2p_controller.rs#L1-L227)
- [message_types.rs:1-100](file://src-tauri/src/utils/message_types.rs#L1-L100)
- [p2p_models.rs:1-150](file://src-tauri/src/entity/p2p_models.rs#L1-L150)
...
- [packages/types/src/p2p/index.ts:1-206](file://packages/types/src/p2p/index.ts#L1-L206)
...
- [p2p_models.rs:81-109](file://src-tauri/src/entity/p2p_models.rs#L81-L109)
