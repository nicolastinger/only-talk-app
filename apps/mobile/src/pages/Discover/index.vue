...
const hotTopics = ref<Topic[]>([
  { id: 1, title: '今日穿搭', participants: 12580, color: '#ff6b6b', cover: '' },
  { id: 2, title: '深夜食堂', participants: 8932, color: '#feca57', cover: '' },
  { id: 3, title: '游戏开黑', participants: 23456, color: '#48dbfb', cover: '' },
  { id: 4, title: '旅行达人', participants: 15678, color: '#1dd1a1', cover: '' },
]);
        ...
        >
          <div class="topic-icon">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path d="M17.53 6.47l-2.12 1.41c-.26.17-.52.35-.79.53l-2.07-1.39-2.94 1.96c-.3-.19-.61-.37-.94-.53L6.5 7.46l-1.97 2.47c-.24-.09-.49-.17-.75-.24l1.42-2.12-2.12-1.41c-.26.17-.52.35-.79.53l-2.07-1.39L0 8.49c.26.17.52.35.79.53l2.07-1.39 2.94 1.96c.3-.19.61-.37.94-.53l2.07 1.39 1.97-2.47c.24.09.49.17.75.24l-1.42 2.12 2.12 1.41c.26-.17.52-.35.79-.53l2.07 1.39 2.94-1.96c.3.19.61.37.94.53l-2.07-1.39 1.97 2.47c.24-.09.49-.17.75-.24l-1.42-2.12z"/>
            </svg>
          </div>
          <span class="topic-title">{{ topic.title }}</span>
          <span class="topic-count">{{ (topic.participants / 10000).toFixed(1) }}万参与</span>
        </div>
      </div>
    </div>
