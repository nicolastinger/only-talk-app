...
// plugins
export { Access, useAccess, useAccessMarkedRoutes } from 'I:/code/rust/umi_gitee/rust-tauri-umi/apps/pc/src/.umi/plugin-access';
export { addLocale, setLocale, getLocale, getIntl, useIntl, injectIntl, formatMessage, FormattedMessage, getAllLocales, FormattedDate, FormattedDateParts, FormattedDisplayName, FormattedHTMLMessage, FormattedList, FormattedNumber, FormattedNumberParts, FormattedPlural, FormattedRelativeTime, FormattedTime, FormattedTimeParts, IntlProvider, RawIntlProvider, SelectLang } from 'I:/code/rust/umi_gitee/rust-tauri-umi/apps/pc/src/.umi/plugin-locale';
export { Provider, useModel } from 'I:/code/rust/umi_gitee/rust-tauri-umi/apps/pc/src/.umi/plugin-model';
export { useRequest, UseRequestProvider, request, getRequestInstance } from 'I:/code/rust/umi_gitee/rust-tauri-umi/apps/pc/src/.umi/plugin-request';
// plugins types.d.ts
export * from 'I:/code/rust/umi_gitee/rust-tauri-umi/apps/pc/src/.umi/plugin-access/types.d';
