import { HTTP_METHOD, TALK_API, FriendRequestInfoDTO, BasicUser } from '@workspace/types';
...
export const process_friend_request = async (friendRequestInfoDTO: FriendRequestInfoDTO) => {
  return await invoke_rust(HTTP_METHOD.POST, '/integrated/process_friend_with_notify', JSON.stringify(friendRequestInfoDTO));
};

export const get_friend_request_list = async (friendRequestInfoDTO: FriendRequestInfoDTO) => {
  return await invoke_rust(HTTP_METHOD.POST, '/friend/get_friend_request_list', JSON.stringify(friendRequestInfoDTO));
};

export const get_accept_friend_request_list = async (friendRequestInfoDTO: FriendRequestInfoDTO) => {
