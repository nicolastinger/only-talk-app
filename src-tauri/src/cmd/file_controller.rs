...
fn create_placeholder_image() -> Result<FileVo, String> {
    ...
    let placeholder_jpg = vec![
        ...
        0x07, 0x06, 0x08, 0x0C, 0x0C, 0x0C, 0x0B, 0x0A, 0x0B, 0x0B, 0x0D, 0x0E,
        0x12, 0x10, 0x0D, 0x0E, 0x11, 0x0E, 0x0B, 0x0B, 0x10, 0x16, 0x10, 0x11,
        0x13, 0x14, 0x15, 0x15, 0x15, 0x0C, 0x0F, 0x17, 0x18, 0x16, 0x14, 0x18,
        0x12, 0x14, 0x15, 0x14, 0xFF, 0xC0, 0x00, 0x0B, 0x08, 0x00, 0x01, 0x00,
    ...
    let file_vo = FileVo {
        file_id: None,
        size: Some(placeholder_jpg.len() as u64),
        file_hash: None,
        created_at: None,
        updated_at: None,
        created_by: None,
...
pub async fn debug_resource_paths(app_handle: tauri::AppHandle) -> Result<String, String> {
    ...
    // 2. 打包的资源路径
    let packed_path = match app_handle
        .path()
