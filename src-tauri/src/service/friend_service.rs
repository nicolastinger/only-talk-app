...
use crate::{entity::system_notification::SystemNotification, store::friend_db::query_friend_info_db};
use anyhow::anyhow;
use log::{info, error};
...
pub async fn process_friend_notify_message(system_notification: SystemNotification) -> Result<(), anyhow::Error> {
    // 处理好友通知
